          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-20">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 flex flex-col">
                  ...
                  <div key={h.dia} className="flex items-center justify-between p-3 px-5 bg-slate-50 rounded-xl border border-transparent hover:border-slate-200 transition-all">
                    ...
                    <div className="flex items-center gap-2">
                      <input 
                        ...
                        className="w-14 bg-white border border-slate-200 rounded-lg p-2 text-[10px] font-black text-center outline-none focus:ring-2 ring-indigo-100" 
                      />
              ...
              <button 
                ...
                disabled={isSaving}
                className={`w-full ${isSaving ? 'bg-slate-400' : 'bg-slate-900 hover:bg-black'} text-white font-black py-5 rounded-2xl mt-8 shadow-xl transition-all active:scale-95 flex items-center justify-center gap-3`}
              >
