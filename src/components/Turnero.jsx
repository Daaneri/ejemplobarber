      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[750px]">
          ...
          <div className="w-full md:w-2/4 p-6 md:p-10">
            ...
            {/* BARRA VIOLETA (Antes dorada) */}
            <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden mb-10">
              <div className="h-full bg-indigo-600 w-1/3"></div>
            </div>

            <h3 className="text-xs font-black uppercase tracking-widest text-slate-900 mb-4 italic">Horarios Disponibles</h3>
          ...
          <div className="w-full md:w-1/4 flex flex-col border-l border-slate-100 bg-white">
            <div className="p-6">
              ...
              <div className="mt-6 h-[180px] w-full rounded-[2rem] overflow-hidden border border-slate-100 shadow-inner relative">
                <iframe title="mapa" width="100%" height="100%" style={{ border: 0 }} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3335.6322302324!2d-60.3323!3d-33.2215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDEzJzE3LjQiUyA2MMKwMTknNTYuMyJX!5e0!3m2!1ses!2sar!4v1620000000000!5m2!1ses!2sar" allowFullScreen="" loading="lazy" className="grayscale"></iframe>
              </div>
